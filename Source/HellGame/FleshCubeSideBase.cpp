...
void UFleshCubeSideBase::ReceivedActivationSignal_Implementation(UFleshCubeSideBase* SendingSide, ESideType SendingType, USkeletalMesh* SkeletalMesh, FTransform SideTransform)
{
}
